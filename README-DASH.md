Bitcoin Light staging tree 0.12.1
===============================
...
are carried out collectively by the network. Bitcoin Light is the name of the open
source software which enables the use of this currency.

For more information, as well as an immediately useable, binary version of
the Bitcoin Light software, see https://www.dash.org/get-dash/.


License
-------

Bitcoin Light is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
stable release versions of Bitcoin Light.
...
[Bitcoin Light's Transifex page](https://www.transifex.com/projects/p/dash/).
