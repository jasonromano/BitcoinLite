...
Bitcoin Light is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Bitcoin Light, where everyone uses
...
pay attention to for reviewers of Bitcoin Light code.

General Bitcoin Light
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bitcoin Light uses tinyformat, which is type safe. Leave them out to avoid confusion
