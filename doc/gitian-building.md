...
*Setup instructions for a Gitian build of Bitcoin Light using a Debian VM or physical system.*
...
- [Building Bitcoin Light](#building-dash-core)
...
Clone the git repositories for Bitcoin Light and Gitian.
...
in the Bitcoin Light repository under 'Fetch and build inputs' to install sources which require
...
To build Bitcoin Light (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Bitcoin Light repository.
