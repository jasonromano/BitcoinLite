...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ BTL, _12_ times over the course of a year totaling _24000_ BTL.
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` BTL to ```y6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using bitcoinlight.conf setup)
