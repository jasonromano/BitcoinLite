...
#Set env vars
buildDir = BUILDDIR
if "BITCOINLITED" not in os.environ:
    os.environ["BITCOINLITED"] = buildDir + '/src/bitcoinlightd' + EXEEXT
if "BITCOINLITECLI" not in os.environ:
    os.environ["BITCOINLITECLI"] = buildDir + '/src/bitcoinlight-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in Bitcoin Light
]
