...
# Objects that map to bitcoinlightd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in bitcoinlightd indicates these should be deserialized as blocks
