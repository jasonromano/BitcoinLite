...
// Copyright (c) 2014-2017 The Bitcoin Light developers
...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Bitcoin Light RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  bitcoinlight-cli [options] <command> [params]  " + _("Send command to Bitcoin Light") + "\n" +
                  "  bitcoinlight-cli [options] help                " + _("List commands") + "\n" +
                  "  bitcoinlight-cli [options] help <command>      " + _("Get help for a command") + "\n";
