...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bitcoin Light bitcoinlight-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinlight-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dash transaction") + "\n" +
              "  bitcoinlight-tx [options] -create [commands]   " + _("Create hex-encoded dash transaction") + "\n" +
              "\n";
