    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bitcoin Light") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bitcoin Light"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoin Light"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoin Light"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Bitcoin Light help message to get a list with possible Bitcoin Light command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bitcoin Light client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitcoin Light network", "", count));
    } else {
...
{
    QString strTitle = tr("Bitcoin Light"); // default title
