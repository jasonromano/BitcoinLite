    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bitcoin Light") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bitcoin Light"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitcoinlight-qt [" + tr("command-line options") + "]                     " + "\n";
...
These denominations are 0.01 BTL, 0.1 BTL, 1 BTL and 10 BTL -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bitcoin Light is shutting down...") + "<br /><br />" +
